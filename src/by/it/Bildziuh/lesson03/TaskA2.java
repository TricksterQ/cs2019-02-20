...
class TaskA2 {
    public static void main(String[] args) {
        String first = "Remember, remember the fifth of November,";
        String second = "Gunpowder treason and plot,";
        String third = "I see no reason why gunpowder treason";
        String fourth = "Should ever be forgot.";
